...
before-all::
	@if [[ ! -f $(UYOU_DEB) ]]; then \
 		curl -s -f -L "https://raw.githubusercontent.com/arichorn/uYou-for-YouTube/main/Packages/com.miro.uyou_$(UYOU_VERSION)_iphoneos-arm.deb" -o $(UYOU_DEB) || curl -s -f -L "https://github.com/arichorn/uYou-for-YouTube/raw/main/Packages/com.miro.uyou_$(UYOU_VERSION)_iphoneos-arm.deb" -o $(UYOU_DEB) || curl -s -L "https://web.archive.org/web/20230819000000id_/https://miro92.com/repo/debs/com.miro.uyou_$(UYOU_VERSION)_iphoneos-arm.deb" -o $(UYOU_DEB); \
 	fi; \
